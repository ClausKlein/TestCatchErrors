...
// stuff that should be fine when used in a header - test cases for example should be registered only
// once
#if 0
...
// to silence GCC warnings when inheriting from some class which has no virtual destructor - happens
// only on gcc 4.7/4.8
